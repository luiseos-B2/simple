...
object HomeScreen : ScreenBuilder {
    ...
    val margin = EdgeValue(top = 10.unitReal(), left = 10.unitReal(), bottom = 10.unitReal())
        ...
        return Screen(
                ...
                child = ScrollView(
                        children = listOf(
                                ...
                                categoriesList.applyStyle(Style(margin = margin)),
                                Text(text = "Oportunidades", styleId = STYLE_TEXT_H1, textColor = DARK_BLUE).applyStyle(style = Style(
                                        margin = EdgeValue(top = 10.unitReal(), left = 10.unitReal())
                                )
                                ),
                                opportunitiesList,
